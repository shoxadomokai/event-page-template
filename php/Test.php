...
//        $mail->addReplyTo($email, $name);
        ...
        $mail->addEmbeddedImage('../images/Sophos_logo.svg.png', 'sophos.png');
                                  ...
                                  <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="100%" style="max-width: 600px;">
                                    ...
                                    <tr>
                                      <td><table cellspacing="0" cellpadding="0" border="0" width="100%">
                                          <tr>
                                            <td style="padding: 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; text-align: center"> Thank you for Registering for the Abuja Technology Expo. We look forward to seeing you there. You can add the event to your calender by clicking the button below.<br>
                                            <br>
                                            Regards,
                                            <br>
                        ...
                        <!-- Button : Begin -->
                                   ...
                                   <table cellspacing="20px" cellpadding="20px" border="0" align="center" width="100%" style="max-width: 600px;">
                                    <tr>
                                      ...
                                      <td style="padding: 20px;"><img src="cid:Sophos_logo.svg.png" width="100" alt="sophos logo" border="0"></td>
...
//        $mail->Subject = 'Abuja Technology Expo';
//        $mail->Body = <<<EOT
//            Dear {$_POST['name']}
//            \n
//            Thank you for Registering for the Abuja Technology Expo. We look forward to seeing you there.
//            \n
//            Regards,
//            \r\n
